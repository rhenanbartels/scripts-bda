...
OUTPUT_TABLE_NAME="tb_pip_detalhe_aproveitamentos"
...
spark-submit --master yarn --deploy-mode cluster \
    ...
    --py-files src/utils.py,packages/*.whl,packages/*.egg,packages/*.zip src/tabela_pip_detalhe_aproveitamentos.py $@ -t ${OUTPUT_TABLE_NAME}
