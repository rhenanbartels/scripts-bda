...
def execute_process(options):
    ...
    spark.sql("""
        ...
        and d.docu_cldc_dk = 392 and sa.stao_tppr_dk
        IN (7912,6548,6326,6681,6678,6645,6682,6680,6679,6644,
            6668,6666,6665,6669,6667,6664,6655,6662,6659,6658,6663
            6661,6660,6657, 6670,6676,6674,6673,6677,6675,6672,6018
            6341,6338,6019,6017,6591,6339, 6553,7871,6343,6340,6342
            6021,6334,6331,6022,6020,6593,6332,7872,6336, 6333,6335
            7745,6346,6345, 6015, 6016, 6325, 6327, 6328, 6329,
            6330, 6337, 6344, 6656, 6671, 7869, 7870, 6324, 6251)
