...
OUTPUT_TABLE_NAME="tb_documentos_arquivados"
...
spark-submit --master yarn --deploy-mode cluster \
    ...
    --py-files ../utilities/*.py,packages/*.whl,packages/*.egg,packages/*.zip src/tabela_documentos_arquivados.py $@ -t ${OUTPUT_TABLE_NAME}
